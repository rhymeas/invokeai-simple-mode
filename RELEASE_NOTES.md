# InvokeAI Simple Mode v1.9.10

Patch release: result cards whose queue record is gone now report Expired instead of polling forever.

Patch release: reloading mid material-report no longer stalls the study card forever.

Patch release: missing-model and unusable-source failures now report honest 4xx statuses instead of 500.
...
- Windows 10/11 only for v1.9.10.
