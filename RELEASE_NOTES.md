# InvokeAI Simple Mode v1.1.0

This update adds native video generation and precise image editing to the unofficial InvokeAI Simple Mode community interface.
